...
srow('Still open (QC review / paper checks)','6 items','ППК25117 printed THC total 1.58 vs own components 15.38 — VERIFY ON PAPER; ППК25154 printed 1.87 same class; BSS052501 sheet 20.47 — probably the NGP result but the NGP scan parses as garbage, read off paper; GP062501 PP cert prints 24.89 vs tranche sheet 22.89 — QC decision; J31112501 sheet 25.00 and J31122501 sheet 21.77 match no certificate in the ingestion folder — source unknown, QC review.')

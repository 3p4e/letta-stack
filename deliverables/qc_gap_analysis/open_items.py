...
ITEMS = [
    ...
    ("OI-39", "Batch identity", "open",
     ...
     "results. Over 93 blocks there are two, and both are unmistakable. **J31122501** "
     ...
     "batch, tested in parallel. **JD112501** (Jelly Donutz, P060212) holds one pair: "
     "ППК26063 and ППК26065 of 11.05.2026, 19.64 % against 13.93 % total THC — six "
     "percentage points apart, which is not one sample read twice. The owner's batch list "
     "gives each cultivation batch exactly one P lot (J31122501 = P060262, JD112501 = "
     "P060212), so the register has no second lot number to file the second sublot under.",
     ...
     "round and the certificate of quality prints the first: 231/0394/26, 100-2-К/26, "
     "1628/2026 and ППК26063. The tracker shows BOTH: J31122501 carries 100-2/1628/231 and "
     "100-3/1625/230 as separate testing instances, JD112501 carries ППК26063 and ППК26065, "
     "so nothing is hidden anywhere the desk shows its working. What the certificate of "
     "quality does not say is WHICH sublot it certifies.",
     "Are J31122501 and JD112501 each one lot or two? If two, what P lot number does the "
     "second carry, and does it need its own certificate of quality — which would make the "
     "four documents the certificates do not print (230/0393/26, 100-3-К/26, 1625/2026, "
     "ППК26065) the second lot's record rather than unused results? If one, which of each "
     "pair is the lot's result?",
     "tracker/RESULT_SUPERSESSION_2026-09-16.md section 2; the register blocks J31122501 "
     "(10 certificates) and JD112501 (2); tracker/batch_dates.csv rows 61 and 64"),

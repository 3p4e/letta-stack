...
ITEMS = [
    ...
    ("OI-38", "Certificate content", "open",
     "Twelve reissues carry the initial microbiology while a later campaign result is on file",
     ...
     "Should a 12-month reissue print the LATEST microbiology on file — the IJZ-MB campaign "
     "of 25/26.08.2026 — instead of carrying the initial result, given that the microbiology "
     "was sampled on a different day from the Farmahem campaign the reissue rests on? And if "
     "it should, does the reissue then cite two samplings on one certificate?",
